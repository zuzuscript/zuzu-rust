...
fn operator_kind(operator: &str) -> &str {
    match operator {
        ...
        "default" => "default",
        "⋀" | "and" => "logical_and",
        "⋀?" | "and?" => "logical_and_value",
        "⋁" | "or" => "logical_or",
        "⋁?" | "or?" => "logical_or_value",
        "⊻" | "xor" => "logical_xor",
        "⊻?" | "xor?" => "logical_xor_value",
        "⊽" | "nor" => "logical_nor",
        "⊽?" | "nor?" => "logical_nor_value",
        "↔" | "xnor" => "logical_xnor",
        "↔?" | "xnor?" => "logical_xnor_value",
        "⊼" | "nand" => "logical_nand",
        "⊼?" | "nand?" => "logical_nand_value",
        "⊨" | "onlyif" => "logical_onlyif",
        "⊨?" | "onlyif?" => "logical_onlyif_value",
        "⊭" | "butnot" => "logical_butnot",
        "⊭?" | "butnot?" => "logical_butnot_value",
        "¬" | "not" | "!" => "logical_not",
        "√" | "sqrt" => "sqrt",
        "⋃" | "union" => "set_union",
